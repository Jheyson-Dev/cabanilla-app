...
import { useProducts, useRetornos, useAreas } from "@/hooks"; // Asegúrate de importar correctamente los hooks
...
export default function RetornoOperations() {
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-semibold">Retorno de Productos</h2>
        <Button onClick={() => setIsSheetOpen(true)}>
          Registrar Nuevo Retorno
        </Button>
      </div>
      {retornosLoading ? (
        <div>Cargando retornos...</div>
      ) : retornosError ? (
        <div>Error al cargar retornos</div>
      ) : (
        <Table>
          <TableHeader>
            <TableRow>
      ...
      <Sheet open={isSheetOpen} onOpenChange={setIsSheetOpen}>
        <SheetContent>
          <SheetHeader>
            <SheetTitle>Registrar Nuevo Retorno</SheetTitle>
            <SheetDescription>
              Complete los detalles para el nuevo retorno de productos.
            </SheetDescription>
          </SheetHeader>
